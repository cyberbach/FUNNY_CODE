 ...
 */
class FLocalSTTApiFunctions
{
public:
	static FLocalSTTApiFunctions& Get()
	{
		static FLocalSTTApiFunctions Instance;
		return Instance;
	}
...
private:
	FLocalSTTApiFunctions() : DllHandle(nullptr) {}
	~FLocalSTTApiFunctions() { FreeLibrary(); }

	void* DllHandle;
};

// Макросы для удобного доступа к функциям
#define LOCALSTT_API(Function) FLocalSTTApiFunctions::Get().Function
